...
_SYSTEM = (
    ...
    "event or era: at most 0.2 - a documentary shows the real thing. Staged "
    "re-enactments, movie scenes with actors, stock actors and music videos are not "
    "the real people either: at most 0.3.\n"
